...
var _viewsContactList = require('./views/contactList');

var _viewsContactList2 = _interopRequireDefault(_viewsContactList);

var _viewsSingle = require('./views/single');

var _viewsSingle2 = _interopRequireDefault(_viewsSingle);
...
var Router = _backbone2['default'].Router.extend({
  ...
  showContact: function showContact() {
    ...
    this.contact.fetch().then((function () {
      ...
      router.$el.html((0, _viewsContactList2['default'])(router.contact.toJSON()));
    }).bind(this));
  },
...
},{"./contact_collection":2,"./views/contactList":6,"./views/single":7,"backbone":9,"jquery":10}],6:[function(require,module,exports){
'use strict';
