...
var APP_ID = 'o6UIfcNFdJioQfVD2O4zzHdO9UbPKwG8Hmd5yXtJ';
var API_KEY = 'ZYGCAVD0oqzfpImCFgUfIs9VFZ9K8cZudjUk3eqt';
...
},{"./contact_model":3,"backbone":10}],3:[function(require,module,exports){
'use strict';
...
},{"./ajax_setup":1,"./router":5,"jquery":11}],5:[function(require,module,exports){
'use strict';
...
var Router = _backbone2['default'].Router.extend({
  ...
  showSpecificContact: function showSpecificContact(contactId) {
    ...
    var list = this.contact.get(contactId);

    if (list) {
      // todos have fetched and we grabbed the one we want
      this.$el.html((0, _viewsContact2['default'])(list.toJSON()));
    } else {
      (function () {
        // todos not fetched so we need to load the one we want
        var router = _this;
        list = _this.contact.add({ objectId: contactId });
        _this.showSpinner();
        list.fetch().then(function () {
          router.$el.html((0, _viewsContact2['default'])(list.toJSON()));
        });
      })();
    }
  },
  ...
  showContact: function showContact() {
    ...
    this.contact.fetch().then(function () {
      ...
      router.$el.html((0, _viewsContact2['default'])(router.contact.toJSON()));
    });
  },
...
},{"./contact_collection":2,"./views/contact":6,"./views/home":7,"./views/list":8,"backbone":10,"jquery":11}],6:[function(require,module,exports){
'use strict';
...
},{"moment":12}],9:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
